'''
这是CamGrad的可视化结果,需要修改simple_test相关内容,包括:
1 rpn_head那里的梯度detached /home/guobo/OBBDetection/mmdet/models/dense_heads/anchor_head.py
2 simple_test的输出改变了 /home/guobo/OBBDetection/mmdet/models/roi_heads/obb/roitrans_roi_head.py line228
3 inference要带梯度了
'''
...
import torchvision
from pytorch_grad_cam import AblationCAM, EigenCAM,GradCAM,ScoreCAM,EigenGradCAM
...
cv2.imwrite('/home/guobo/OBBDetection/featuremap/test333.png',cam_image)