...
cfg = Config.fromfile("/home/zlx/mmdetection/work_dirs/GF-RarePlanes/fasterr50_gpus/config.py")
model = build_detector(cfg.model, test_cfg=cfg.get('test_cfg')).cuda()

checkpoint = load_checkpoint(model, "/home/zlx/mmdetection/work_dirs/GF-RarePlanes/fasterr50_gpus/epoch_24.pth", map_location='cuda')
