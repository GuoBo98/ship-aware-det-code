_base_ = [
    '../_base_/datasets/shipdataset_IS.py',
...
# optimizer 4 gpus batchsize=4,lr=0.02
optimizer = dict(type='SGD', lr=0.02, momentum=0.9, weight_decay=0.0001)

resume_from = "/home/guobo/OBBDetection/TrainTest/work_dirs/v007_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5/epoch_72.pth"
