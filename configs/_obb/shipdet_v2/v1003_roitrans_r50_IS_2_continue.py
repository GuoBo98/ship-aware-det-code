...
方法:ROITrans-res50 + IS Switch的概率改为0.2
'''


_base_ = [
    '../_base_/datasets/shipdatasetv2_IS_2.py',
...
# optimizer 4 gpus batchsize=2,lr=0.01
optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001)
resume_from = "/home/guobo/OBBDetection/TrainTest_v2/work_dirs/v1003_roitrans_r50_IS_2/epoch_80.pth"
