...
ship_name = ['Cargo-vessel', 'Ship', 'Motorboat', 'Fishing-boat','Destroyer', 'Tugboat', 'Loose-pulley', 'Warship','Engineering-ship', 
             'Amphibious-ship', 'Cruiser', 'Frigate','Submarine', 'Aircraft-carrier', 'Command-ship','Hovercraft']
...
if __name__ == '__main__':
    ...
    DOTA2COCOTrain(r'/data2/guobo/01_Ship-Whu/train/',
                   r'/data2/guobo/01_Ship-Whu/train/ship_whu_train.json',
                   ship_name)
