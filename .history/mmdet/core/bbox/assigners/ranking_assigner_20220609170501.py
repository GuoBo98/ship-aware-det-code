...
class RankingAssigner(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None):
        ...
        if self.inside_circle == 'circle':
            ...
            gt_bboxes_xywhz = self.hbb2obb(gt_bboxes)
            device1 = gt_bboxes_xywhz.device
            xy_t, sigma_t = self.xy_wh_r_2_xy_sigma(gt_bboxes_xywhz)
            xy_a = bboxes[...,:2]
