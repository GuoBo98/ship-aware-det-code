...
class DOTADataset(CustomDataset):
    ...
    def evaluate(self,
        ...
        if metric == 'mAP':
            ...
            finetune_cls = ["Other-Aircraft-Carrier","Enterprise","Nimitz","Midway","Other-Destroyer","Atago-DD","Arleigh-Burke-DD","Hatsuyuki-DD","Hyuga-DD","Asagiri-DD","Other-Landing","YuTing-LL","YuDeng-LL","YuDao-LL","YuZhao-LL","Austin-LL","Osumi-LL","Wasp-LL","LSD-41-LL","LHA-LL","AOE"]
            cls = []
            aps = []
            for idx in range(len(self.CLASSES)):
                class_name = self.CLASSES[idx]
                if class_name in finetune_cls:
                    cls.append(class_name)
                    aps.append(_[idx]['ap'])
            finetune_dict = dict(zip(cls,aps))
