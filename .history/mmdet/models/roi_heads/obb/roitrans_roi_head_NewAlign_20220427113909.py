...
class RoITransRoIHeadNewAlign(OBBBaseRoIHead):
    ...
    def __init__(self,
        ...
        super(RoITransRoIHeadNewAlign, self).__init__(
    ...
    def simple_test(self, x, proposal_list, img_metas, rescale=False):
        ...
        # return results, det_bboxes, det_labels
        return results

    def simple_test_for_cam(self, x, proposal_list, img_metas, rescale=False):
        """Test without augmentation."""
        assert self.with_bbox, 'Bbox head must be implemented.'
        img_shape = img_metas[0]['img_shape']
        ori_shape = img_metas[0]['ori_shape']
