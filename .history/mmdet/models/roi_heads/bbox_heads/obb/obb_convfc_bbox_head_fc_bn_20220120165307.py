...
class OBBConvFCBBoxHead(OBBoxHead):
    ...
    def __init__(self,
        ...
        self.fc_bn_1 = nn.BatchNorm1d(1024)
        self.fc_bn_2 = nn.BatchNorm1d(1024)
        self.fc_bn_1.cuda()
        self.fc_bn_2.cuda()
    ...
    def forward(self, x):
        ...
        if self.num_shared_fcs > 0:
            ...
            x = self.relu(self.fc_bn_1(self.shared_fcs[0](x)))
            x = self.relu(self.fc_bn_2(self.shared_fcs[1](x)))
        # separate branches
        x_cls = x
        x_reg = x
