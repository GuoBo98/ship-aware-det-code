...
if __name__ == '__main__':
    ...
    obb_rois_sel = obb_rois[21:22]
    
    for i in range(len(obb_rois_sel)):
        obb_roi = obb_rois_sel[i]
    ...
    rois = torch.tensor(obb_rois_sel, dtype=torch.double, device="cuda")
    rois_output = roi_align_rotated(img, rois, (197, 398), 1, 1, True)
