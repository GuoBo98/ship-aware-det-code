...
def main():
    ...
    for img_dir, ann_dir in zip(args.img_dirs, args.ann_dirs):
        _infos, classes = load_func(
            ...
            #HRSC Train class
            # classes = ['08', '16', '15', '09', '01', '07', '25', '05', '19', '13', '30', '10', 
            #            '03', '11', '22', '20', '24', '18', '27', '06', '28', '32', '26', '29', '02', '04'],
            
            #HRSC Test class
            classes = ['25', '01', '09', '11', '16', '15', '10', '07', '29', '22', '20', '27', '32', '03', '08', '19', '30', '18', '05', '04', '06', '13', '26', '17', '12', '28', '24'],
            nproc=args.nproc)
