...
data_root = '/data2/guobo/01_SHIPRSDET/dota-format/split_ss_1024/'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(type='DOTASpecialIgn ore', ignore_size=2),
...
#         type=dataset_type,
#         task='Task1',
#         ann_file=data_root + 'trainval/labelTxt-v1.0/',
#         img_prefix=data_root + 'trainval/images/',
#         pipeline=train_pipeline),
#     test=dict(
#         type=dataset_type,
#         task='Task1',
#         ann_file=data_root + 'test/labelTxt-v1.0/',
