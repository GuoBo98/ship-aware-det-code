'''这里是给了新的比例262，之前都是343,将四部分cut到一起，重新分类'''
_base_ = [
    '../_base_/datasets/shipdataset.py', '../_base_/schedules/schedule_3x.py',
...
model = dict(
    ...
    roi_head=dict(
        type='RoITransRoIHead_PCB_cat_fc',
        num_stages=2,
        ...
        bbox_roi_extractor=[
            ...
            dict(
                ...
                roi_layer=dict(
                    type='RoIAlignRotated', out_size=7, sample_num=2),
                out_channels=256,
        ...
        bbox_head=[
            dict(
                ...
                loss_bbox=dict(type='SmoothL1Loss', beta=1.0,
                               loss_weight=1.0)),
            dict(
                type='OBBShared2FCBBoxHeadCatFC',
                start_bbox_type='obb',
                end_bbox_type='obb',
                in_channels=256,
                fc_out_channels=1024,
...
total_epochs = 48
resume_from = "/home/guobo/OBBDetection/TrainTest/work_dirs/v901_faster_rcnn_roitrans_r50_fpn_PCB_cutFC_262/epoch_5.pth"