...
def split_roisv2(obb_rois):
    ...
    '''新的rois'''
    new_idx = torch.cat(idx_greater,idx_lower)
    new_obb_rois = obb_rois[new_idx]
    
    
    return new_obb_rois,obb_rois_top,obb_rois_middle,obb_rois_down
