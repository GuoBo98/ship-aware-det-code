...
os.system("bash /home/guobo/OBBDetection/tools/dist_test.sh \
           ...
           /data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1005_roitrans_r50_without_bn/epoch_68.pth \
           4\
           --format-only \
           --options \
           save_dir=/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1005_roitrans_r50_without_bn/results-68/"
          )
