...
'''v010-椭圆arr = [3.5,9,4,9,2.5,2] 学习率0.01'''
os.system("bash /home/guobo/OBBDetection/tools/dist_train.sh \
            /home/guobo/OBBDetection/configs/_obb/shipdet/v010_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian_arr[3.5, 9, 4, 9, 2.5, 2].py 2"
          )