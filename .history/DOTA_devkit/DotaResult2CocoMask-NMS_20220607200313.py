...
if __name__ == '__main__':
    ...
    results_file = 'results-76'
    dota_result_path = os.path.join(work_dirs, results_file)
    voc_result_path = os.path.join(work_dirs, results_file + '-' + str(th) + '-voc')
    voc_result_cross_path = os.path.join(work_dirs,
                                         results_file + '-' + str(th) + '-cross-voc')
    ...
    mmcv.dump(final_objects_nms_mask,
              os.path.join(work_dirs, results_file + '-' + str(th) + '-nms-mask.json'))

    mmcv.dump(final_objects_nms_cross_mask,
              os.path.join(work_dirs, results_file + '-' + str(th) +  '-nms-cross-mask.json'))
