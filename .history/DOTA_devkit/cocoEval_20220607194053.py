...
v1505_Attention0000_86 = "/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1505_ShipIS_GRoI_RRoIAlign_75_Attention0000/results-86-nms-mask.json"
v1505_Attention0000_81 = "/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1505_ShipIS_GRoI_RRoIAlign_75_Attention0000/results-81-nms-mask.json"

v1501_roiTrans_nms = "/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1501_ShipIS_GRoI_RRoIAlign_75/results-76-nms-cross-mask.json"
v1702_roitrans_gwd_k10 = "/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1702_roitrans_gwd_k10/results-70-nms-mask.json"
v1702_roitrans_gwd_k10_nms = "/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1702_roitrans_gwd_k10/results-70-nms-cross-mask.json"

v1501_roiTrans_76_th05 = "/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1501_ShipIS_GRoI_RRoIAlign_75/results-760.05-nms-mask.json"
cocoGT = COCO(annFile_v2)
cocoDT = cocoGT.loadRes(v1501_roiTrans_76_th05)
...
for i in range(len(categories)):
    ...
    voc_map_info_list.append(stats[1])
