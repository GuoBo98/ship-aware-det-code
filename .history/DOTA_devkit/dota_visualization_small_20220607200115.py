...
if __name__ == '__main__':
    ...
    imagePath = "/data/guobo/01_SHIPRSDET/ShipDetv2/Voc/val_set/images/"
    gtPath = "/data/guobo/01_SHIPRSDET/ShipDetv2/Voc/val_set/xmls/"

    work_dirs = '/data/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1006_1_faster_rcnn_roitrans_r50_fpn/'
    resultPath = os.path.join(work_dirs, 'results-72-0.05--cross-voc/')
    draw_image_save_path = os.path.join(work_dirs, 'results-72-cross-show-small/')
