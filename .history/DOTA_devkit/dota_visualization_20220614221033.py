...
if __name__ == '__main__':
    ...
    work_dirs = '/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1601_faster_rcnn_orpn_r50_fpn/'
    resultPath = os.path.join(work_dirs, 'results-65-cross-voc/')
    draw_image_save_path = os.path.join(work_dirs, 'results-65-cross-show/')
