...
if __name__ == '__main__':
    ...
    work_dirs = '/home/guobo/OBBDetection/TrainTest_v2/work_dirs/v1102_faster_rcnn_orpn_r50_fpn_IS5/'
    resultPath = os.path.join(work_dirs, 'results-75-voc/')
    save_img_path = os.path.join(work_dirs, 'confusion_matrix_75.png')
    save_img_path_norm = os.path.join(work_dirs,
                                      'confusion_matrix_75_norm.png')
