...
if __name__ == '__main__':
    ...
    work_dirs = '/data2/guobo/01_SHIPRSDET/TrainTestv2/work_dirs/v1604_orpn_IS_obbGRoI_RRoIAlign_75/'
    resultPath = os.path.join(work_dirs, 'results-88-cross-voc/')
    draw_image_save_path = os.path.join(work_dirs, 'results-88-cross-show/')
