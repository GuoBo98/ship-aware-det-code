...
'''v1005-without-bn'''
# os.system("CUDA_VISIBLE_DEVICES=1,2,3 bash /home/guobo/OBBDetection/tools/dist_train.sh \
#             /home/guobo/OBBDetection/configs/_obb/shipdet_v2/v1005_roitrans_r50_without_bn.py 3"
#           )

'''v1006用了双分支boxhead'''
os.system("CUDA_VISIBLE_DEVICES=1,2,3 bash /home/guobo/OBBDetection/tools/dist_train.sh \
            /home/guobo/OBBDetection/configs/_obb/shipdet_v2/v1006_roitrans_r50_twoBranch.py 3"
          )
