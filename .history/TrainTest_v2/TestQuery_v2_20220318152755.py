...
# '''v009-72-epoch'''
# os.system("bash /home/guobo/OBBDetection/tools/dist_test.sh \
#            /home/guobo/OBBDetection/TrainTest/work_dirs/v009_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian/v009_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian.py \
#            /home/guobo/OBBDetection/TrainTest/work_dirs/v009_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian/epoch_72.pth \
#            2\
#            --format-only \
#            --options \
#            save_dir=/home/guobo/OBBDetection/TrainTest/work_dirs/v009_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian/results-72/"
#           )


'''v010-68-epoch'''
os.system("bash /home/guobo/OBBDetection/tools/dist_test.sh \
           /home/guobo/OBBDetection/TrainTest/work_dirs/v010_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian_arr/v010_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian_arr.py \
           /home/guobo/OBBDetection/TrainTest/work_dirs/v010_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian_arr/epoch_68.pth \
           4\
           --format-only \
           --options \
           save_dir=/home/guobo/OBBDetection/TrainTest/work_dirs/v010_faster_rcnn_roitrans_r50_fpn_IS_crop_0.5_gassian_arr/results-68/"
          )
